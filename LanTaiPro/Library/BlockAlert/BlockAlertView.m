...
+ (void)initialize
{
    if (self == [BlockAlertView class])
    {
        ...
        titleFont = [UIFont fontWithName:@"HiraginoSansGB-W3" size:18];
        messageFont = [UIFont fontWithName:@"HiraginoSansGB-W6" size:20];
        buttonFont = [UIFont fontWithName:@"HiraginoSansGB-W3" size:18];
    }
}
...
- (void)show
{
    ...
    for (NSUInteger i = 0; i < _blocks.count; i++)
    {
        ...
        UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"%@.png", color]];
