...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"HiraginoSansGB-W6" size:kLabelFontSize];
        self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont fontWithName:@"HiraginoSansGB-W6" size:kDetailsLabelFontSize];
